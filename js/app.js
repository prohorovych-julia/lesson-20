(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-team__slider")) new core(".slider-team__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-team__arrow.swiper-button-prev",
                nextEl: ".slider-team__arrow.swiper-button-next"
            },
            breakpoints: {
                640: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".slider-testimonials__content")) new core(".slider-testimonials__content", {
